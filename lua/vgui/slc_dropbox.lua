...
function PANEL:DoClick()
    if IsValid(self.DropMenu) then
        ...
        cont.Think = function(this)
            if not this:HasHierarchicalFocus() then
                if this.HadFocus then this:Remove() end
            else
                this.HadFocus = true
            end
        end
        ...
        close.DoClick = function(this) cont:Remove() end
        ...
        pnl.VBar:SetWide(6)
        pnl.VBar.Paint = function(this, pw, ph) draw.RoundedBox(15, 0, 0, pw, ph, color_vbar) end
        pnl.VBar.btnGrip.Paint = function(this, pw, ph) draw.RoundedBox(15, 1, 1, pw - 2, ph - 2, color_vbar_grip) end
