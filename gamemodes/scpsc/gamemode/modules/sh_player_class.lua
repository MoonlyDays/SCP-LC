...
function PLAYER:SetupDataTables()
    ...
    if SERVER then
        ...
        SLCPromiseJoin(ply:GetSCPData("level", 0), ply:GetSCPData("xp", 0), ply:GetSCPData("class_points", 0), ply:GetSCPData("daily_bonus", 0), ply:GetSCPData("prestige_points", 0), ply:GetSCPData("prestige_level", 0), ply:GetSCPData("spectator_points", -1)):Then(function(data)
            ...
            --REMOVE
            if tonumber(data[7]) == -1 then ply:SetSpectatorPoints((tonumber(data[6]) * 35 + tonumber(data[1])) * 3550) end
        end)
    end

    if CLIENT then ply:RequestSLCVars() end
end
