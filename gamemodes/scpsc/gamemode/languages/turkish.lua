...
wep.KEYCARD = {
    author = "danx91",
    instructions = "Erişim:",
    ACC = {"SAFE", "EUCLID", "KETER", "Kontrol Noktası", "OMEGA Savaş Başlığı", "Genel Erişim", "Geçit A", "Geçit B", "Armory", "UYLUK KIRICI", "EC",},
    STATUS = {"ERİŞİM", "ERİŞİM YOK",},
    NAMES = {"Kart Level 1", "Kart Level 2", "Kart Level 3", "Araştırmacı Kartı", "MTF Bekçi Kartı", "MTF Kumandan Kartı", "Kart Seviye OMNI", "Kontrol Noktası Bekçi Kartı", "Hacklenmiş Kaos İsyancısı Kartı",},
}
