...
function ENT:Initialize()
    ...
    DestroyOnWarhead(self, outside, not outside)
end
...
if CLIENT then
    ...
    SCPHook("SCP106", "PostDrawTranslucentRenderables", function()
        ...
        local alpha = 1
        if not GetSettingsValue("scp106_spots") then
        ...
        if not wep.SelectedSpot then return end
    ...
    hook.Add("SLCRegisterSettings", "SCP106Spot", function() RegisterSettingsEntry("scp106_spots", "switch", false, nil, "scp_config") end)
end
