...
function SWEP:SetupDataTables()
    ...
    self:NetworkVarNotify("Rating", function(ent, name, old, new) if CLIENT then self.PrintName = self.OrigName .. " " .. new .. "A" end end)
end
...
function SWEP:Equip()
    if CLIENT then self.PrintName = self.OrigName .. " " .. self:GetRating() .. "A" end
end
