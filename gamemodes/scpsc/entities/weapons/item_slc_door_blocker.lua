...
function SWEP:PrimaryAttack()
    ...
    owner:StartSLCTask("door_blocker", self.UseTime, function(ply) return IsValid(self) and owner:KeyDown(IN_ATTACK) and owner:GetActiveWeapon() == self end, {
...
Hooks
---------------------------------------------------------------------------]]
hook.Add("SLCUseOverride", "SLCDoorBlocker", function(ply, ent, data) if ent.DoorLocked and ent.DoorLocked >= CurTime() then return true, false end end)
--[[-------------------------------------------------------------------------
Sounds
---------------------------------------------------------------------------]]
sound.Add({
    ...
    level = 80,
    pitch = {90, 110},
    sound = {"weapons/stunstick/alyx_stunner1.wav", "weapons/stunstick/alyx_stunner2.wav",},
    channel = CHAN_WEAPON,
})
